...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(27, 88, 194));
        lblID = new JLabel("ID:");
        ...
        lblPesoenGB = new JLabel("Peso en GB:");
        ...
        panel2.setBackground(new Color(61, 38, 162));
        info = new ArrayList<>();
        info.add(new Videojuego(1,"Sonic Frontiers","Plataformas",15.80,"Multiplataforma","Sega"));
